...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggleCheckbox(checkbox) {
        ...
        if (isChecked) {
            ...
            checkbox.querySelector('i').classList.remove('fa-check-square');
            checkbox.querySelector('i').classList.add('fa-square');
        } else {
            checkbox.setAttribute('aria-checked', 'true');
            checkbox.querySelector('i').classList.remove('fa-square');
            checkbox.querySelector('i').classList.add('fa-check-square');
        }
    }
